...
#define PATH_SEPERATOR "/";
	...
	////////////////////////////////////////////////////////////////////////////////
	static void getListOfFilesInDir(const QString& directory, vector<QString>& files);
	...
	////////////////////////////////////////////////////////////////////////////////
	static void getListOfDirsInDir(const QString& directory, vector<QString>& directories);

	////////////////////////////////////////////////////////////////////////////////
	/// \brief     Delete all the files given
	/// \param[in] files 	Files to be deleted
	////////////////////////////////////////////////////////////////////////////////
	static void deleteFiles(const vector<QString>& files);
